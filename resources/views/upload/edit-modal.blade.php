            ...
            <div class="modal-body" >
                ...
                <form action="{{ url('upload/'.$data->id) }}" href="javascript:void(0)" method="POST" id="editForm" name="editForm" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('created_at') is invalid @enderror" id="created_at" name="created_at" value="{{ old('created_at', $data->created_at) }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_bull') is invalid @enderror" id="nama_bull" name="nama_bull" value="{{ old('name', $data->nama_bull) }}">
                    </div>
                    <div class="form-group">
